\begin{abstract}
    ...
    - Automatic assessment of Scratch programs is needed
      ...
      - Scratch does not have normal input / output like normal computer programs, but is based on multimedia
    ...
    - Whisker allows GUI testing for Scratch by checking the programs behavior to user inputs
    - it has two main ways to test programs
      - by simulating user input
      - by letting the user use the program and checking in the background
