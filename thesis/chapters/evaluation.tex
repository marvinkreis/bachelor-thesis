...
\begin{table}[htpb]
    ...
    \begin{tabular}{rl|cr|cr|cr}
        ...
        18 & Banana must wait for a second before falling down in the beginning        & \cmark & 18 & \xmark & 18 & \cmark & 18 \\
        19 & Banana must wait for a second before falling down after displaying ''-8'' & \cmark & 19 & \xmark & 19 & \cmark & 19 \\[\medskipamount]
...
\mnote{TODO: Remove if updated test suite fixed it}
...
We analyzed the flakiness of the test suites and measured a percentage of $2.76\%$ inconsistent project-test combinations for test suite T1, $2.74\%$ for test suite T2, and $12.00\%$ for test suite T3.
