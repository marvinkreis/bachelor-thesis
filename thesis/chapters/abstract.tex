...
\begin{abstract}
    ...
    In order to solve this problem, we implemented Whisker, a program, which automates Scratch 3.0's IO to make dynamic testing possible.
    ...
    Furthermore, we evaluated Whisker's automated input generation by measuring its achieved coverage on the sample solutions to CodeClub's Scratch courses.
