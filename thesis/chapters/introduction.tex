...
Not only teachers would be able profit from dynamic testing for Scratch, it can also be very useful for students.
For one thing, they can receive valuable feedback by running their teacher's tests on their programs themselves.
Like this, students can identify and fix errors in their programs before submitting them.
In some cases, maybe even a variant of test driven development can be adopted.
At the same time, dynamic testing is also helpful for self-study.
