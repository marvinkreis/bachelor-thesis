...
% Scratch also has an online repository with over $37$ million community-made Scratch projects.
...
\begin{enumerate}
    ...
    \item[(2)] % Automated input generation is a viable method to control Scratch programs for testing purposes.
