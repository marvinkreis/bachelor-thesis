...
Whisker is available at \url{https://github.com/marvinkreis/whisker}.
...
\begin{enumerate}[(1)]
    \item Test results can be accurate enough to aid in grading Scratch assignments.
        ...
        between our test results and independent manual scores and an average percentage of $5.84\%$ of test-project pairs that showed inconsistent test outcomes over ten test executions.
