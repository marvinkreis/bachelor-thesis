...
which is called at a constant frequency of 30 times per second.
...
Whisker runs its own loop, which in turn calls Scratch's \texttt{step} function.
...
\mnote{TODO: only works with Scratch 3.0 projects}
