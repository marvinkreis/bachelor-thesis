...
which opens up some usage possibilities for Whisker.
\mnote{TODO: check if this is actually possible, should be}
For example, it should be possible to create a browser addon to add Whisker to the original Scratch page in the future.
...
\mnote{TODO: Write about the user interacts with the inputs (input objects)?}
\mnote{TODO: Explain how inputs are saved}
